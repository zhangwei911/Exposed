...
//                }
    ...
    fun testBinaryWithoutLength() {
        ...
        withDb(listOf(TestDB.Jdbc.POSTGRESQL, TestDB.Jdbc.POSTGRESQLNG, TestDB.Rdbc.POSTGRESQL, TestDB.Jdbc.SQLITE)) {
    ...
    fun createTableWithCompositePrimaryKeyAndSchema() {
        ...
        withSchemas(excludeSettings = listOf(TestDB.Jdbc.SQLITE), schemas = arrayOf(one)) {
